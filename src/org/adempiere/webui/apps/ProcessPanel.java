...
public class ProcessPanel extends ProcessController implements SmallViewEditable, EventListener, ASyncProcessPOS {
	 ...
	 */
	public ProcessPanel(int WindowNo, ProcessInfoPOS pi) {
	 ...
	 *  @param pi process info
	 */
	public ProcessPanel(IZKProcessDialog parent, int WindowNo, ProcessInfoPOS pi, String width) {
	 ...
	 * @param columns
	 */
	public ProcessPanel(int WindowNo, ProcessInfoPOS pi, String width, int columns) {
	...
	@Override
	public CEditorPOS createEditor(GridField field) {
		return((CEditorPOS)WebEditorFactoryPOS.getEditor(field, false));
	}

	public void formatEditor(CEditorPOS editor1, CEditorPOS editor2) {
		//
	...
	protected void runProcess() {
		...
		WProcessCtl worker = new WProcessCtl((IProcessUI)this, getWindowNo(), getProcessInfo(), null);
		worker.run();
		//	Run
	}
