...
public class CPOS {
	...
	public int getDefaultParner() {
		...
		return entityPOS.getC_BPartnerCashTrx_ID();		
	}
	...
	private void generateShipment(String trxName) {
		...
		/*ProcessInfo processInfo = ProcessBuilder
				...
				.withParameter(MInOut.COLUMNNAME_C_BPartner_ID, getC_BPartner_ID())
	...
	public int getM_PriceList_ID() {
		return entityPOS.getM_PriceList_ID();
	}	//	getM_PriceList_ID
	...
	protected MPriceListVersion loadPriceListVersion(int priceListId) {
		...
		MPriceList priceList = MPriceList.get(ctx, entityPOS.getM_PriceList_ID(), null);
		//
