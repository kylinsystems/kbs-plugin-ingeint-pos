 ...
 * @author ocurieles, https://www.ingeint.com
 */
	...
	implements EventListener
{
	 ...
	 *	@return button
	 */
	protected Button createButtonAction (String action, String accelerator, String optionalName)
	{
		...
		if (optionalName==null)
			...
			button.setTooltiptext(accelerator+"-"+Msg.translate(ctx, optionalName));
