...
public class WPOSInfoProduct extends WPOSSubPanel {
	...
	protected void init() {
		...
		buttonPanel.setStyle("border: none; width:100%;moz-box-shadow: 0 0 0px #888;-webkit-box-shadow: 0 0 0px #888;box-shadow: 0 0 0px #888;");
		...
		parameterPanel.setStyle("border: none; width:100%;");
		Rows rows = null;
		Row  row = null;
		...
		buttonImage.setWidth("200px");
		buttonImage.setHeight("125px");
		...
		labelValue.setStyle(WPOS.FONTSIZESMALL+" font-weight:bold");
		//	Add
		...
		//	For Name
		labelName = new Label ();
		labelName.setStyle(WPOS.FONTSIZESMALL+" font-weight:bold");
		//	Add
		...
		labelPriceName.setStyle(WPOS.FONTSIZESMALL+" font-weight:bold");
		//	Add
		row.appendChild(labelPriceName);
		
		//  For Price List
		labelPriceName2 = new Label ();
		labelPriceName2.setStyle(WPOS.FONTSIZESMALL+" font-weight:bold");
		//	Add
		row.appendChild(labelPriceName2);

		row = rows.newRow();
		labelPrice = new Label ();
		labelPrice.setStyle(WPOS.FONTSIZESMALL+"font-weight:bold");
		//	Add
		row.appendChild(labelPrice);
		
		labelPriceList = new Label ();
		labelPriceList.setStyle(WPOS.FONTSIZESMALL+"font-weight:bold");
		//	Add
		...
		if (ClientInfo.maxWidth(1400)) {
			row = rows.newRow();
			labelUOMSymbol.setStyle(WPOS.FONTSIZESMALL+" font-weight:bold");
			//	Add
			row.appendChild(labelUOMSymbol);
			
			row = rows.newRow();
			labelProductCategory.setStyle(WPOS.FONTSIZESMALL+" font-weight:bold");
			//	Add
			row.appendChild(labelProductCategory);
		
			row = rows.newRow();
			labelProductTax.setStyle(WPOS.FONTSIZESMALL+" font-weight:bold");
			//	Add
	...
	public void initialValue() {
		...
		labelPriceName.setText(Msg.parseTranslation(ctx , "@PriceStd@ ") + posPanel.getCurSymbol());
		labelPriceName2.setText(Msg.parseTranslation(ctx , "@PriceList@ ") + posPanel.getCurSymbol());
	...
	public void resetValues() {
		...
		labelPriceName2.setText(NO_TEXT);
